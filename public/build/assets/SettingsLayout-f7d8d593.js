import{r as i,N as u,O as w,W as x,z as b,P as y,a as e,b as l,d3 as k,Z as S}from"./vendor-react-579edc05.js";import{ar as p,E as d,aC as m}from"./main-be11fefe.js";const h={passive:!0};function $(){const[t,s]=i.useState({width:0,height:0}),a=i.useCallback(()=>{s({width:window.innerWidth||0,height:window.innerHeight||0})},[]);return p("resize",a,h),p("orientationchange",a,h),i.useEffect(a,[]),t}const N=d(u)`
