import{r as i,N as u,O as w,W as x,E as b,P as y,a as e,b as l,dj as k,Z as S}from"./vendor-react-90378f5b.js";import{aq as p,H as d,aE as m}from"./main-783d11ee.js";const h={passive:!0};function $(){const[t,s]=i.useState({width:0,height:0}),a=i.useCallback(()=>{s({width:window.innerWidth||0,height:window.innerHeight||0})},[]);return p("resize",a,h),p("orientationchange",a,h),i.useEffect(a,[]),t}const N=d(u)`
...
`,C=({indexPattern:t,defaultUrl:s,contentBlock:a,routes:g})=>{const r=x(),{width:n}=$(),o=b(t),v=y();i.useEffect(()=>{n>960&&o&&v(m(s,r[r.length-1].params),{replace:!0})},[o,n]);const f=a??i.Fragment;return e("div",{className:"bg-background min-h-screen",children:e(f,{children:l(W,{className:o?"border-b border-accent-200":"",children:[n>960||o?e(z,{children:g.map(c=>e(N,{to:m(c.path,r[r.length-1].params),end:c.end,children:c.name},c.name))}):null,l("div",{className:" col-span-3",children:[n<=960&&!o?l(L,{to:m(t,r[r.length-1].params),children:[e(k,{className:"w-5 h-5"}),e("span",{children:"Settings"})]}):null,e("div",{className:"space-y-8",children:e(S,{})})]})]})})})};export{C as S};
