import{r as i,N as u,O as w,W as x,z as b,P as y,a as e,b as l,db as k,Z as S}from"./vendor-react-2a0062a7.js";import{ap as p,E as d,aC as m}from"./main-04bfd220.js";const h={passive:!0};function $(){const[t,s]=i.useState({width:0,height:0}),a=i.useCallback(()=>{s({width:window.innerWidth||0,height:window.innerHeight||0})},[]);return p("resize",a,h),p("orientationchange",a,h),i.useEffect(a,[]),t}const N=d(u)`
