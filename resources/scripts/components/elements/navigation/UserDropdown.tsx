    ...
    return (
        <div className='hidden sm:flex items-center space-x-3.5'>
            ...
            <Menu width={240} position='bottom-end' withinPortal zIndex={9999} shadow='xl'>
                <Menu.Target>
                    <button className='group flex items-center space-x-3 bg-neutral-900/60 hover:bg-neutral-800/80 border border-white/10 hover:border-white/20 backdrop-blur-md rounded-2xl px-3 py-1.5 transition-all duration-200 cursor-pointer active:scale-95 shadow-md'>
                        <span className='text-stone-200 group-hover:text-white font-bold text-xs tracking-tight transition-colors'>
                            {user.name}
                        </span>
                ...
                <Menu.Dropdown>
                    ...
                    <div className='px-3 py-2 mb-1 border-b border-white/10'>
                        ...
                        <p className='text-[11px] font-medium text-stone-400 truncate'>{user.email}</p>
                    </div>
                    ...
                    {user.rootAdmin && (
                        <>
                            ...
                            >
                                <span className='text-stone-200 font-bold'>{adminLabel}</span>
                            </Menu.Item>
                        </>
                    )}
