...
const ScreenBlock = ({
    ...
    return (
        ...
        >
            ...
            >
                {Icon && (
                    <Icon className='w-16 h-16 border dark:border-gray-600 rounded-md p-3 text-black dark:text-gray-400 mx-auto' />
                )}

                <h2 className='text-gray-900 dark:text-white font-bold text-4xl mt-6'>
                    {title}
                </h2>
