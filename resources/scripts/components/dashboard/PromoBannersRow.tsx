...
const PromoBannersRow = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8'>
                ...
                <div className='relative z-10 pl-8 pr-8'>
                    ...
                    <div className='flex flex-wrap items-baseline gap-4'>
                        ...
                        <span className='text-2xl font-black text-blue-400'>
                            UP TO <span className='text-4xl text-white'>40%</span> OFF
                        </span>
                    </div>
            ...
            {/* Refer and Earn Card */}
            <div className='bg-gradient-to-b from-[#18233c] to-[#0f1422] border border-blue-500/20 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between shadow-2xl'>
                <div className='text-center relative z-10'>
                    ...
                    <h3 className='text-base font-bold text-white'>Refer and Earn</h3>
                    <p className='text-xs text-stone-300 mt-1.5 max-w-xs mx-auto leading-relaxed'>
                        Referring clients to Convoy Cloud and earn 15% commission on successful sales.
                    </p>
                </div>
                <button className='w-full py-2.5 rounded-xl bg-[#1c263c] hover:bg-[#25324e] border border-blue-400/20 text-white font-bold text-xs mt-4 flex items-center justify-center gap-2 transition active:scale-95 cursor-pointer shadow-md'>
                    Refer Now &rarr;
                </button>
            </div>
        </div>
