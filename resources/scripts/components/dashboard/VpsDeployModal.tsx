                                                    ...
                                                    return (
                                                        <Card
                                                            ...
                                                            className={cn(
                                                                ...
                                                                isSelected
                                                                    ? 'bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900 shadow-[0px_0px_40px_-5px_rgba(59,130,246,0.6)] z-20 border-blue-500 ring-2 ring-blue-500/40'
                                                                    : 'bg-neutral-900 border-neutral-700 z-10 hover:border-neutral-600 hover:shadow-[0px_0px_20px_-5px_rgba(59,130,246,0.2)]'
                                                            )}
                                                        >
