...
type AwardBadgeType = "golden-kitty" | "product-of-the-day" | "product-of-the-month" | "product-of-the-week" | "certified-staff";
...
const backgroundColor = ["#12141c", "#0f172a", "#1e1b4b"];

export const AwardBadge = ({
  type = "certified-staff",
  place,
  link,
  titleText = "Certified Vertex Staff Member",
  subTitleText = "VERTEX CLOUD",
}: AwardBadgeProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-[180px] sm:w-[260px] h-auto drop-shadow-md">
          <defs>
            <filter id="blur1">
          ...
          <rect x="4" y="4" width="252" height="46" rx="8" fill="transparent" stroke="#eab308" strokeWidth="1" opacity="0.6" />
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="8" fontWeight="bold" fill="#eab308" x="52" y="19" letterSpacing="0.8">
            {subTitleText}
          </text>
          <text fontFamily="Helvetica-Bold, Helvetica" fontSize="9.5" fontWeight="bold" fill="#ffffff" x="52" y="37">
            {titleText}
          </text>
