...
Route::get('/plans', [Admin\AdminVpsPlansController::class, 'index']);
Route::post('/plans', [Admin\AdminVpsPlansController::class, 'store']);
Route::delete('/plans/{id}', [Admin\AdminVpsPlansController::class, 'destroy']);
...
Route::prefix('/roles')->group(function () {
    ...
    Route::post('/revoke-admin', [Admin\AdminRoleController::class, 'revokeAdmin']);
